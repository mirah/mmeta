# generated by mmeta on Thu Aug 26 17:35:46 PDT 2010
...
;end
  ...
  def #{n}
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('#{n}')
    _t=_retrieve(\"#{@name}.#{n}\"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    #{localsAsInit}    begin
    #{b}
    _t=_exit(_memoize(\"#{@name}.#{n}\", _start, _t))
...
"
  ...
  def File
    ...
    xs = Object(nil)
    begin
    begin; _p47=_pos; _t=nil; begin  # and
    as46 = ArrayList.new
    while true  # many
    _t=self.trans();
    ...
    break if _t == BaseParser.__ERROR__
  end while false; self._pos=_p47 if (_t==BaseParser.__ERROR__); end
