# generated by mmeta on Thu Aug 26 23:22:29 PDT 2010
...
;end
  ...
  def destruct
    ...
    _enter('destruct')
    _t=_retrieve("MMetaCompiler.destruct"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    t = r = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.destruct", _start, _t))
  ...
  def trans
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('trans')
    _t=_retrieve("MMetaCompiler.trans"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    r = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.trans", _start, _t))
  ...
  def HList
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('HList')
    _t=_retrieve("MMetaCompiler.HList"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    ls = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.HList", _start, _t))
  ...
  def HConcat
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('HConcat')
    _t=_retrieve("MMetaCompiler.HConcat"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    l = r = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.HConcat", _start, _t))
  ...
  def HStr
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('HStr')
    _t=_retrieve("MMetaCompiler.HStr"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    c = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.HStr", _start, _t))
  ...
  def HLit
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('HLit')
    _t=_retrieve("MMetaCompiler.HLit"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    c = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.HLit", _start, _t))
  ...
  def Node
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Node')
    _t=_retrieve("MMetaCompiler.Node"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    n = c = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Node", _start, _t))
  ...
  def Error
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Error')
    _t=_retrieve("MMetaCompiler.Error"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    msg = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Error", _start, _t))
  ...
  def Set
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Set')
    _t=_retrieve("MMetaCompiler.Set"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    n = x = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Set", _start, _t))
  ...
  def Str
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Str')
    _t=_retrieve("MMetaCompiler.Str"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    s = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Str", _start, _t))
  ...
  def Sym
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Sym')
    _t=_retrieve("MMetaCompiler.Sym"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    s = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Sym", _start, _t))
  ...
  def App
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('App')
    _t=_retrieve("MMetaCompiler.App"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    ...
    _t=_exit(_memoize("MMetaCompiler.App", _start, _t))
  ...
  def Dot
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Dot')
    _t=_retrieve("MMetaCompiler.Dot"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
        begin
    _t="if _start == _pos;_t=ws();_real_start=_pos;nil;else;_t=ws();end;";
    _t=_exit(_memoize("MMetaCompiler.Dot", _start, _t))
  ...
  def SAct
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('SAct')
    _t=_retrieve("MMetaCompiler.SAct"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    expr = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.SAct", _start, _t))
  ...
  def Act
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Act')
    _t=_retrieve("MMetaCompiler.Act"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    expr = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Act", _start, _t))
  ...
  def Pred
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Pred')
    _t=_retrieve("MMetaCompiler.Pred"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    expr = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Pred", _start, _t))
  ...
  def SynPred
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('SynPred')
    _t=_retrieve("MMetaCompiler.SynPred"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    pred = t = e = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.SynPred", _start, _t))
    end while (_t==BaseParser.__GROW__); BaseParser.__ERROR__.last="SynPred" if (_t==BaseParser.__ERROR__); return _t;
  end

  def Token
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Token')
    _t=_retrieve("MMetaCompiler.Token"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    name = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Token", _start, _t))
    end while (_t==BaseParser.__GROW__); BaseParser.__ERROR__.last="Token" if (_t==BaseParser.__ERROR__); return _t;
  end

  def TokenRange
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('TokenRange')
    _t=_retrieve("MMetaCompiler.TokenRange"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    ...
    _t=_exit(_memoize("MMetaCompiler.TokenRange", _start, _t))
    end while (_t==BaseParser.__GROW__); BaseParser.__ERROR__.last="TokenRange" if (_t==BaseParser.__ERROR__); return _t;
  end

  def TLit
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('TLit')
    _t=_retrieve("MMetaCompiler.TLit"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    name = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.TLit", _start, _t))
    end while (_t==BaseParser.__GROW__); BaseParser.__ERROR__.last="TLit" if (_t==BaseParser.__ERROR__); return _t;
  end

  def Or
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Or')
    _t=_retrieve("MMetaCompiler.Or"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    x = xs = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Or", _start, _t))
  ...
  def And
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('And')
    _t=_retrieve("MMetaCompiler.And"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    ts = Object(nil)
    begin
    _t=BaseParser.__ERROR__; begin  # or
    ...
    _t=_exit(_memoize("MMetaCompiler.And", _start, _t))
  ...
  def Many
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Many')
    _t=_retrieve("MMetaCompiler.Many"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    x = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Many", _start, _t))
  ...
  def Many1
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Many1')
    _t=_retrieve("MMetaCompiler.Many1"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    x = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Many1", _start, _t))
  ...
  def Opt
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Opt')
    _t=_retrieve("MMetaCompiler.Opt"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    x = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Opt", _start, _t))
  ...
  def Not
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Not')
    _t=_retrieve("MMetaCompiler.Not"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    x = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Not", _start, _t))
  ...
  def Peek
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Peek')
    _t=_retrieve("MMetaCompiler.Peek"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    x = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Peek", _start, _t))
  ...
  def List
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('List')
    _t=_retrieve("MMetaCompiler.List"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    x = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.List", _start, _t))
  ...
  def MemoRule
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('MemoRule')
    _t=_retrieve("MMetaCompiler.MemoRule"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    n = b = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.MemoRule", _start, _t))
    end while (_t==BaseParser.__GROW__); BaseParser.__ERROR__.last="MemoRule" if (_t==BaseParser.__ERROR__); return _t;
  end

  def Rule
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Rule')
    _t=_retrieve("MMetaCompiler.Rule"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    n = b = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Rule", _start, _t))
  ...
  def Scope
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Scope')
    _t=_retrieve("MMetaCompiler.Scope"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    ...
    _t=_exit(_memoize("MMetaCompiler.Scope", _start, _t))
  ...
  def Parser
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Parser')
    _t=_retrieve("MMetaCompiler.Parser"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    p = n = s = xs = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Parser", _start, _t))
  ...
  def Method
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Method')
    _t=_retrieve("MMetaCompiler.Method"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    c = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Method", _start, _t))
  ...
  def Field
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Field')
    _t=_retrieve("MMetaCompiler.Field"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    c = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Field", _start, _t))
  ...
  def Package
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Package')
    _t=_retrieve("MMetaCompiler.Package"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    c = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Package", _start, _t))
  ...
  def Import
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Import')
    _t=_retrieve("MMetaCompiler.Import"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    c = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Import", _start, _t))
  ...
  def Class
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Class')
    _t=_retrieve("MMetaCompiler.Class"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    q = d = c = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Class", _start, _t))
  ...
  def Line
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('Line')
    _t=_retrieve("MMetaCompiler.Line"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    ws = x = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.Line", _start, _t))
  ...
  def File
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('File')
    _t=_retrieve("MMetaCompiler.File"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    xs = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.File", _start, _t))
  ...
  def start
    _t=Object(nil); _start=_pos; _real_start=-1;
    _enter('start')
    _t=_retrieve("MMetaCompiler.start"); return _exit(_t) if (_t!=BaseParser.__NOT_MEMOIZED__)
    r = Object(nil)
    begin
    ...
    _t=_exit(_memoize("MMetaCompiler.start", _start, _t))
