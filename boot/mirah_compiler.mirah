...
class MMetaCompiler < BaseParser
  ...
  def rule_body(n:Object, b:Object, force_memo:boolean, type:Object)
          ...
          if force_memo || @auto_memo
            ...
            add_expr(:BODY, b, @dict.addSection(:RULE_BODY))
          else
            @dict.showSection(:UNMEMO)
            @dict.showSection(:NO_RECURSION)
            add_expr(:RULE_BODY, b)
          end
          render('rule')
