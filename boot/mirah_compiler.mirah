# generated by mmeta on Mon Aug 02 17:56:49 PDT 2010
...
class MMetaCompiler < BaseParser
  ...
  def HList
    ...
    ls = Object(nil)
    begin
    begin; _p3=_pos; _t=__ERROR__; begin  # and
    as2 = ArrayList.new
    while true  # many
    _t=trans();
  ...
  def App
    ...
    begin; _p16=_pos; _t=__ERROR__; begin  # and
      _t=_any();
      rule=_t;
      break if _t == __ERROR__
      as15 = ArrayList.new
  ...
  def Pred
    ...
    expr = Object(nil)
    begin
    begin; _p20=_pos; _t=__ERROR__; begin  # and
    _t=_any();
    expr=_t;
    break if _t == __ERROR__
  ...
  def List
    ...
    x = Object(nil)
    begin
    begin; _p31=_pos; _t=__ERROR__; begin  # and
    _t=indent();
    break if _t == __ERROR__
    _t=trans();
    x=_t;
...
"
  ...
  def Parser
    ...
    p = n = s = xs = Object(nil)
    begin
    begin; _p34=_pos; _t=__ERROR__; begin  # and
    _t=_any();
    p=_t;
    break if _t == __ERROR__
    _t=_any();
    ...
    break if _t == __ERROR__
  end while false; self._pos=_p34 if (_t==__ERROR__); end
  ...
  def File
    ...
    while true  # many
    _t=trans();
    if (_t==__ERROR__); break; else as41.add(_t);nil;end
    end; _t=as41
