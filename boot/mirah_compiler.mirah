# generated by mmeta on Tue Aug 24 16:20:25 PDT 2010
...
class MMetaCompiler < BaseParser
  ...
  def SynPred
    ...
    e=_t;
    raise SyntaxError.new("", _pos, _string, _list) if _t == BaseParser.__ERROR__
    _t="#{pred}\n#{outdent}unless _t == BaseParser.__ERROR__\n#{t}\n#{@_}else\n#{e}\n#{@_}end\n";
    raise SyntaxError.new("", _pos, _string, _list) if _t == BaseParser.__ERROR__
  ...
  def Token
    ...
    name=_t;
    break if _t == BaseParser.__ERROR__
    _t="#{@_}_t = _lex(#{lookup_token(name)})  # #{name}\n";
    break if _t == BaseParser.__ERROR__
...
"
  ...
  def Parser
    ...
    while true  # many
    _t=self.trans();
    if (_t==BaseParser.__ERROR__); break; else as37.add(_t);nil;end
    end; _t=as37
  ...
  def File
    ...
    while true  # many
    _t=self.trans();
    if (_t==BaseParser.__ERROR__); break; else as45.add(_t);nil;end
    end; _t=as45
