# generated by mmeta on Wed Jul 21 23:12:45 PDT 2010
...
class MMetaCompiler < BaseParser
  ...
  def Node
    ...
    n = c = Object(nil)
    begin
    begin; _p9=_pos; _t=__ERROR__; begin  # and
    _t=_any();
    n=_t;
    break if _t == __ERROR__
    _t=trans();
  ...
  def Error
    ...
    msg = Object(nil)
    begin
    begin; _p11=_pos; _t=__ERROR__; begin  # and
    _t=_any();
    msg=_t;
    break if _t == __ERROR__
    _t=(
  ...
  def Sym
    ...
    s = Object(nil)
    begin
    begin; _p15=_pos; _t=__ERROR__; begin  # and
    _t=_any();
    s=_t;
    break if _t == __ERROR__
    _t="_t=_sym(\"#{s}\");";
    break if _t == __ERROR__
  end while false; self._pos=_p15 if (_t==__ERROR__); end
  ...
  def App
    ...
    begin; _p18=_pos; _t=__ERROR__; begin  # and
      ...
      if (_t!=__ERROR__)
        ...
        while true  # many
        _t=trans();
        if (_t==__ERROR__); break; else as16.add(_t);nil;end
        end; _t=as16
    ...
    begin; _p19=_pos; _t=__ERROR__; begin  # and
      _t=_sym("super");
      break if _t == __ERROR__
      _t=_any();
      rule=_t;
    ...
    begin; _p22=_pos; _t=__ERROR__; begin  # and
      _t=_any();
      rule=_t;
      break if _t == __ERROR__
      as20 = ArrayList.new
      ...
      if (_t!=__ERROR__)
        ...
        while true  # many
        _t=trans();
        if (_t==__ERROR__); break; else as20.add(_t);nil;end
        end; _t=as20
      ...
      break if _t == __ERROR__
    end while false; self._pos=_p22 if (_t==__ERROR__); end
  ...
  def And
    ...
    begin
    _t=__ERROR__; begin  # or
    begin; _p36=_pos; _t=__ERROR__; begin  # and
      _t=indent();
      break if _t == __ERROR__
      as34 = ArrayList.new
      _t=trans();
  ...
  def List
    ...
    x = Object(nil)
    begin
    begin; _p45=_pos; _t=__ERROR__; begin  # and
    _t=indent();
    break if _t == __ERROR__
    _t=trans();
    x=_t;
    ...
    break if _t == __ERROR__
  end while false; self._pos=_p45 if (_t==__ERROR__); end
  ...
  def Rule
    ...
    n = b = Object(nil)
    begin
    begin; _p47=_pos; _t=__ERROR__; begin  # and
    _t=_any();
    n=_t;
    break if _t == __ERROR__
    _t=trans();
...
"
    ...
    break if _t == __ERROR__
  end while false; self._pos=_p47 if (_t==__ERROR__); end
  ...
  def Parser
    ...
    while true  # many
    _t=trans();
    if (_t==__ERROR__); break; else as49.add(_t);nil;end
    end; _t=as49
  ...
  def Class
    ...
    c = Object(nil)
    begin
    begin; _p57=_pos; _t=__ERROR__; begin  # and
    _t=_any();
    c=_t;
    break if _t == __ERROR__
    _t=c;
    break if _t == __ERROR__
  end while false; self._pos=_p57 if (_t==__ERROR__); end
  ...
  def File
    ...
    while true  # many
    _t=trans();
    if (_t==__ERROR__); break; else as60.add(_t);nil;end
    end; _t=as60
  ...
  def start
    ...
    r = Object(nil)
    begin
    begin; _p63=_pos; _t=__ERROR__; begin  # and
    _t=destruct();
    r=_t;
    raise SyntaxError.new("", _pos, _string, _list) if _t == __ERROR__
    _t=__end__();
    ...
    _t=r;
    raise SyntaxError.new("", _pos, _string, _list) if _t == __ERROR__
  end while false; self._pos=_p63 if (_t==__ERROR__); end
