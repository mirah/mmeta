package jmeta;
// generated by jmeta on Fri Jul 16 10:54:35 PDT 2010
...
public class JMetaParser extends BaseParser {  public static void main(String[] args) {
  ...
  public Object cbraces() { Object _t=null; int _start=_pos;
    ...
    { int _p54=_pos; _t=ERROR; do { //and
      _t=_str("{");
      if (_t==ERROR) break;
      java.util.ArrayList<Object> as52=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=cbraces();
      if (_t==ERROR) break; else as52.add(_t);
      } _t=as52;
      xs=_t;
      if (_t==ERROR) break;
      _t=_str("}");
  ...
  public Object rule() { Object _t=null; int _start=_pos;
    ...
    x=_t;
    if (_t==ERROR) break;
    java.util.ArrayList<Object> as81=new java.util.ArrayList<Object>();
    while (true) { //many
    ...
    if (_t==ERROR) break; else as81.add(_t);
    } _t=as81;
    xs=_t;
    if (_t==ERROR) break;
    _t=ws();
  ...
  public Object qualifiers() { Object _t=null; int _start=_pos;
    ...
    java.util.ArrayList<Object> as92=new java.util.ArrayList<Object>();
    _t=ERROR; do{ //or
    ...
    if (_t!=ERROR) { as92.add(_t);
      ...
      if (_t==ERROR) break; else as92.add(_t);
      } _t=as92;
    }
    qs=_t;
    if (_t==ERROR) break;
  ...
  public Object method() { Object _t=null; int _start=_pos;
    ...
    { int _p105=_pos; _t=ERROR; do { //and
      ...
      _t=_str("{");
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      java.util.ArrayList<Object> as103=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=cbraces();
      if (_t==ERROR) break; else as103.add(_t);
      } _t=as103;
      bs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=_str("}");
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=__act104(q,r,n,as,bs,s);
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
  ...
  public Object classdef() { Object _t=null; int _start=_pos;
    ...
    _t=_str("{");
    if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
    java.util.ArrayList<Object> as120=new java.util.ArrayList<Object>();
    while (true) { //many
    _t=cbraces();
    if (_t==ERROR) break; else as120.add(_t);
    } _t=as120;
    bs=_t;
    if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
    _t=_str("}");
  ...
  public Object parser() { Object _t=null; int _start=_pos;
    ...
    _t=_str("{");
    if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
    java.util.ArrayList<Object> as128=new java.util.ArrayList<Object>();
    while (true) { //many
    _t=ruleMethod();
    if (_t==ERROR) break; else as128.add(_t);
    } _t=as128;
    rs=_t;
    if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
    _t=ws();
...
Object __act49(Object rs, Object ls, Object xs, Object n, Object s){ return new Object[] {"HLit", "@"+n}; }
Object __act53(Object xs){ return "{"+ join(xs) +"}"; }
Object __act58(Object s, Object xs){ return new Object[] {"Act", join(xs)}; }
Object __act61(Object xs){ return new Object[] {"Pred", join(xs)}; }
boolean __pred83(Object rn, Object n){ return n.equals(rn); }
Object __act93(Object qs){
        return join(qs, " ");
    }
Object __act98(Object q, Object r, Object n, Object as, Object bs){
        String body = ""+ q +" "+ r +" "+ n +"("+ join(as) +") {"+ join(bs) +"}";
        return new Object[] {"Method", body };
    }
Object __act104(Object q, Object r, Object n, Object as, Object bs, Object s){
        String body = "def " + s + n + "("+ join(as) +");" + join(bs) + ";end";
        return new Object[] {"Method", body};
    }
Object __act108(Object q, Object t, Object n, Object xs){
        String body = ""+ q +" "+ t +" "+ n +" = "+ join(xs) +";";
        return new Object[] {"Field", body } ;
    }
Object __act112(Object stm, Object xs){
...
Object __act121(Object q, Object xs, Object bs){
        String body = ""+ q +" class "+ join(xs) +" {"+ join(bs) +"}";
        return new Object[] {"Class", body } ;
    }
Object __act129(Object p, Object n, Object sn, Object rs){ return new JMetaOptimizer().parse(p, "optimizeGrammar"); }
Object __act131(Object p, Object l){ return new Object[] {"Line", join(p), l}; }
 ...
 class JMetaPass extends BaseParser {  public boolean changed =  false;
  ...
  public Object Or() { Object _t=null; int _start=_pos;
    ...
    java.util.ArrayList<Object> as139=new java.util.ArrayList<Object>();
    while (true) { //many
    _t=trans();
    if (_t==ERROR) break; else as139.add(_t);
    } _t=as139;
    xs=_t;
    if (_t==ERROR) break;
    _t=concat(new Object[] {"Or"},xs);
...
Object __act135(){changed = true; return null;}
boolean __pred136(Object r){return hasRule(r);}
 ...
 class JMetaOptimizer extends BaseParser {
  public Object optimizeGrammar() { Object _t=null; int _start=_pos;
    ...
    sn=_t;
    if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
    java.util.ArrayList<Object> as162=new java.util.ArrayList<Object>();
    while (true) { //many
    _t=optimizeRule();
    if (_t==ERROR) break; else as162.add(_t);
    } _t=as162;
    rs=_t;
    if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
    _t=end();
