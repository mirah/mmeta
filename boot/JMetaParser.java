package jmeta;
// generated by jmeta on Thu Aug 26 17:35:45 PDT 2010
...
public class JMetaParser extends BaseParser {  public static void main(String[] args) {
  ...
  public Object classdef() { Object _t=null; int _start=_pos;
    ...
    { int _p150=_pos; _t=ERROR; do { //and
      ...
      _push("class"); _t=k();
      if (_t==ERROR) break;
      java.util.ArrayList<Object> as147=new java.util.ArrayList<Object>();
      while (true) { //many
      ...
      if (_t==ERROR) break; else as147.add(_t);
      } _t=as147;
      xs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=_str("{");
...
boolean __pred108(Object rn, Object n){ return n.equals(rn); }
Object __act121(Object qs){
        return join(qs, " ");
    }
Object __act126(Object q, Object r, Object n, Object as, Object bs){
        String body = ""+ q +" "+ r +" "+ n +"("+ join(as) +") {"+ join(bs) +"}";
        return new Object[] {"Method", body };
    }
Object __act132(Object q, Object r, Object n, Object as, Object bs, Object s){
        String body = "def " + s + n + "("+ join(as) +");" + join(bs) + ";end";
        return new Object[] {"Method", body};
    }
Object __act136(Object q, Object t, Object n, Object xs){
        String body = ""+ q +" "+ t +" "+ n +" = "+ join(xs) +";";
        return new Object[] {"Field", body } ;
    }
Object __act140(Object stm, Object xs){
        String body = stm + join(xs) +";";
        return new Object[] {"Import", body };
    }
Object __act144(Object stm, Object xs){
        String body = stm + join(xs) +";";
        return new Object[] {"Package", body };
    }
Object __act149(Object q, Object xs, Object bs){
        String decl = " class "+ join(xs);
        String body = join(bs);
        return new Object[] {"Class", q, decl, body } ;
    }
Object __act157(Object p, Object n, Object sn, Object rs){
                   if (Boolean.getBoolean("jmeta.optimize.debug")) {
                     System.out.println("Before:\n" + print_r(p));
                   }
                   return new JMetaOptimizer().parse(p, "optimizeGrammar");
                }
Object __act159(Object p, Object l){ return new Object[] {"Line", join(p), l}; }
 ...
 class JMetaPass extends BaseParser {  public boolean changed =  false;
  ...
  public Object And() { Object _t=null; int _start=_pos;
    ...
    { int _p170=_pos; _t=ERROR; do { //and
      java.util.ArrayList<Object> as169=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=trans();
      if (_t==ERROR) break; else as169.add(_t);
      } _t=as169;
      xs=_t;
      if (_t==ERROR) break;
      _t=concat(new Object[] {"And"},xs);
  ...
  public Object start() { Object _t=null; int _start=_pos;
    ...
    _t=ERROR; do{ //or
      ...
      { int _p183=_pos; _t=ERROR; do { //and
        java.util.ArrayList<Object> as182=new java.util.ArrayList<Object>();
        while (true) { //many
        _t=_any();
        if (_t==ERROR) break; else as182.add(_t);
        } _t=as182;
        r=_t;
        if (_t==ERROR) break;
        _t=end();
...
Object __act163(){changed = true; return null;}
boolean __pred164(Object r){return hasRule(r);}
 ...
 class JMetaOptimizer extends BaseParser {
  public Object optimizeGrammar() { Object _t=null; int _start=_pos;
    ...
    { int _p194=_pos; _t=ERROR; do { //and
      ...
      sn=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      java.util.ArrayList<Object> as192=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=optimizeRule();
      if (_t==ERROR) break; else as192.add(_t);
      } _t=as192;
      rs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=end();
...
Object __act193(Object p, Object n, Object sn, Object rs, Object x){ if (Boolean.getBoolean("jmeta.optimize.debug")) {
                         System.out.println("Opt:\n" + print_r(x));
                       }
                       return x;
                     }
Object __act195(Object r){
