package jmeta;
// generated by jmeta on Wed Jul 21 23:12:44 PDT 2010
...
public class JMetaParser extends BaseParser {  public static void main(String[] args) {
  ...
  public Object fname() { Object _t=null; int _start=_pos;
    ...
    java.util.ArrayList<Object> as45=new java.util.ArrayList<Object>();
    while (true) { //many
    ...
    if (_t==ERROR) break; else as45.add(_t);
    } _t=as45;
    t=_t;
    if (_t==ERROR) break;
    _t=name();
  ...
  public Object cbraces() { Object _t=null; int _start=_pos;
    ...
    { int _p69=_pos; _t=ERROR; do { //and
      _t=_str("{");
      if (_t==ERROR) break;
      java.util.ArrayList<Object> as67=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=cbraces();
      if (_t==ERROR) break; else as67.add(_t);
      } _t=as67;
      xs=_t;
      if (_t==ERROR) break;
      _t=_str("}");
  ...
  public Object rule() { Object _t=null; int _start=_pos;
    ...
    x=_t;
    if (_t==ERROR) break;
    java.util.ArrayList<Object> as97=new java.util.ArrayList<Object>();
    while (true) { //many
    ...
    if (_t==ERROR) break; else as97.add(_t);
    } _t=as97;
    xs=_t;
    if (_t==ERROR) break;
    _t=ws();
  ...
  public Object method() { Object _t=null; int _start=_pos;
    ...
    { int _p115=_pos; _t=ERROR; do { //and
      ...
      _t=_str("{");
      if (_t==ERROR) break;
      java.util.ArrayList<Object> as113=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=cbraces();
      if (_t==ERROR) break; else as113.add(_t);
      } _t=as113;
      bs=_t;
      if (_t==ERROR) break;
      _t=_str("}");
      if (_t==ERROR) break;
      _t=__act114(q,r,n,as,bs);
      if (_t==ERROR) break;
    ...
    { int _p121=_pos; _t=ERROR; do { //and
      ...
      _t=_str("{");
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      java.util.ArrayList<Object> as119=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=cbraces();
      if (_t==ERROR) break; else as119.add(_t);
      } _t=as119;
      bs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=_str("}");
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=__act120(q,r,n,as,bs,s);
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
  ...
  public Object jpackage() { Object _t=null; int _start=_pos;
    ...
    stm=_t;
    if (_t==ERROR) break;
    java.util.ArrayList<Object> as131=new java.util.ArrayList<Object>();
    while (true) { //many
    { int _p130=_pos; _t=ERROR; do { //and
                _t=_str(";");
        if (_t==ERROR) { _t=true; } else { _t=ERROR; }
        if (_t==ERROR) break;
        _t=_any();
        if (_t==ERROR) break;
      } while(false); if (_t==ERROR) _pos=_p130; }
    if (_t==ERROR) break; else as131.add(_t);
    } _t=as131;
    xs=_t;
    if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
    _t=_str(";");
...
Object __act43(Object x){return ((String)x)+".";}
Object __act46(Object x, Object t, Object n){return join(t) + n;}
Object __act50(Object x){return "("+join(x)+")";}
Object __act52(Object n, Object p){ return new Object[] {"HLit", ((String)n)+p}; }
Object __act64(Object rs, Object ls, Object xs, Object n, Object s){ return new Object[] {"HLit", "@"+n}; }
Object __act68(Object xs){ return "{"+ join(xs) +"}"; }
Object __act73(Object s, Object xs){ return new Object[] {"Act", join(xs)}; }
Object __act77(Object xs){ return new Object[] {"Pred", join(xs)}; }
boolean __pred99(Object rn, Object n){ return n.equals(rn); }
Object __act109(Object qs){
        return join(qs, " ");
    }
Object __act114(Object q, Object r, Object n, Object as, Object bs){
        String body = ""+ q +" "+ r +" "+ n +"("+ join(as) +") {"+ join(bs) +"}";
        return new Object[] {"Method", body };
    }
Object __act120(Object q, Object r, Object n, Object as, Object bs, Object s){
        String body = "def " + s + n + "("+ join(as) +");" + join(bs) + ";end";
        return new Object[] {"Method", body};
    }
Object __act124(Object q, Object t, Object n, Object xs){
        String body = ""+ q +" "+ t +" "+ n +" = "+ join(xs) +";";
        return new Object[] {"Field", body } ;
    }
Object __act128(Object stm, Object xs){
        String body = stm + join(xs) +";";
        return new Object[] {"Import", body };
    }
Object __act132(Object stm, Object xs){
        String body = stm + join(xs) +";";
        return new Object[] {"Package", body };
    }
Object __act137(Object q, Object xs, Object bs){
        String body = ""+ q +" class "+ join(xs) +" {"+ join(bs) +"}";
        return new Object[] {"Class", body } ;
    }
Object __act145(Object p, Object n, Object sn, Object rs){ return new JMetaOptimizer().parse(p, "optimizeGrammar"); }
Object __act147(Object p, Object l){ return new Object[] {"Line", join(p), l}; }
 ...
 class JMetaPass extends BaseParser {  public boolean changed =  false;
  ...
  public Object Or() { Object _t=null; int _start=_pos;
    ...
    java.util.ArrayList<Object> as155=new java.util.ArrayList<Object>();
    while (true) { //many
    _t=trans();
    if (_t==ERROR) break; else as155.add(_t);
    } _t=as155;
    xs=_t;
    if (_t==ERROR) break;
    _t=concat(new Object[] {"Or"},xs);
  ...
  public Object start() { Object _t=null; int _start=_pos;
    ...
    { int _p169=_pos; _t=ERROR; do { //and
      java.util.ArrayList<Object> as168=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=_any();
      if (_t==ERROR) break; else as168.add(_t);
      } _t=as168;
      r=_t;
      if (_t==ERROR) break;
      _t=end();
...
Object __act151(){changed = true; return null;}
boolean __pred152(Object r){return hasRule(r);}
