package jmeta;
// generated by jmeta on Tue Aug 24 13:47:59 PDT 2010
 ...
 class JMetaOptimizer extends BaseParser {
  public Object optimizeGrammar() { Object _t=null; int _start=_pos;
    ...
    { int _p190=_pos; _t=ERROR; do { //and
      ...
      sn=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      java.util.ArrayList<Object> as188=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=optimizeRule();
      if (_t==ERROR) break; else as188.add(_t);
      } _t=as188;
      rs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=end();
...
Object __act189(Object p, Object n, Object sn, Object rs, Object x){ if (Boolean.getBoolean("jmeta.optimize.debug")) {
                         System.out.println("Opt:\n" + print_r(x));
                       }
                       return x;
                     }
Object __act191(Object r){
