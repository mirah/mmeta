package jmeta;
// generated by jmeta on Wed Jul 21 22:06:16 PDT 2010
...
public class JMetaParser extends BaseParser {  public static void main(String[] args) {
  ...
  public Object rewrite_expr() { Object _t=null; int _start=_pos;
    ...
    Object n=null; Object c=null;    do {
    _t=ERROR; do{ //or
    ...
    { int _p45=_pos; _t=ERROR; do { //and
      ...
      n=_t;
      if (_t==ERROR) break;
      java.util.ArrayList<Object> as44=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=rewrite_expr();
      if (_t==ERROR) break; else as44.add(_t);
      } _t=as44;
      c=_t;
      if (_t==ERROR) break;
      _t=ws();
  ...
  public Object cbraces() { Object _t=null; int _start=_pos;
    ...
    { int _p57=_pos; _t=ERROR; do { //and
      _t=_str("{");
      if (_t==ERROR) break;
      java.util.ArrayList<Object> as55=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=cbraces();
      if (_t==ERROR) break; else as55.add(_t);
      } _t=as55;
      xs=_t;
      if (_t==ERROR) break;
      _t=_str("}");
  ...
  public Object semPred() { Object _t=null; int _start=_pos;
    ...
    _t=_str("?{");
    if (_t==ERROR) break;
    java.util.ArrayList<Object> as64=new java.util.ArrayList<Object>();
    while (true) { //many
    _t=cbraces();
    if (_t==ERROR) break; else as64.add(_t);
    } _t=as64;
    xs=_t;
    if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
    _t=_str("}");
  ...
  public Object expr4() { Object _t=null; int _start=_pos;
    ...
    java.util.ArrayList<Object> as68=new java.util.ArrayList<Object>();
    while (true) { //many
    _t=expr3();
    if (_t==ERROR) break; else as68.add(_t);
    } _t=as68;
    xs=_t;
    if (_t==ERROR) break;
  ...
  public Object rule() { Object _t=null; int _start=_pos;
    ...
    x=_t;
    if (_t==ERROR) break;
    java.util.ArrayList<Object> as85=new java.util.ArrayList<Object>();
    while (true) { //many
    ...
    if (_t==ERROR) break; else as85.add(_t);
    } _t=as85;
    xs=_t;
    if (_t==ERROR) break;
    _t=ws();
  ...
  public Object method() { Object _t=null; int _start=_pos;
    ...
    { int _p103=_pos; _t=ERROR; do { //and
      ...
      _t=_str("{");
      if (_t==ERROR) break;
      java.util.ArrayList<Object> as101=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=cbraces();
      if (_t==ERROR) break; else as101.add(_t);
      } _t=as101;
      bs=_t;
      if (_t==ERROR) break;
      _t=_str("}");
      if (_t==ERROR) break;
      _t=__act102(q,r,n,as,bs);
      if (_t==ERROR) break;
    ...
    { int _p109=_pos; _t=ERROR; do { //and
      ...
      _t=ERROR; do{ //or
        { int _p106=_pos; _t=ERROR; do { //and
          ...
          _t=_str("(");
          if (_t==ERROR) break;
          java.util.ArrayList<Object> as105=new java.util.ArrayList<Object>();
          while (true) { //many
          ...
          if (_t==ERROR) break; else as105.add(_t);
          } _t=as105;
          as=_t;
          if (_t==ERROR) break;
          _t=_str(")");
  ...
  public Object classdef() { Object _t=null; int _start=_pos;
    ...
    _t=_str("{");
    if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
    java.util.ArrayList<Object> as124=new java.util.ArrayList<Object>();
    while (true) { //many
    _t=cbraces();
    if (_t==ERROR) break; else as124.add(_t);
    } _t=as124;
    bs=_t;
    if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
    _t=_str("}");
  ...
  public Object parser() { Object _t=null; int _start=_pos;
    ...
    _t=_str("{");
    if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
    java.util.ArrayList<Object> as132=new java.util.ArrayList<Object>();
    while (true) { //many
    _t=ruleMethod();
    if (_t==ERROR) break; else as132.add(_t);
    } _t=as132;
    rs=_t;
    if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
    _t=ws();
...
Object __act52(Object rs, Object ls, Object xs, Object n, Object s){ return new Object[] {"HLit", "@"+n}; }
Object __act56(Object xs){ return "{"+ join(xs) +"}"; }
Object __act61(Object s, Object xs){ return new Object[] {"Act", join(xs)}; }
Object __act65(Object xs){ return new Object[] {"Pred", join(xs)}; }
boolean __pred87(Object rn, Object n){ return n.equals(rn); }
Object __act97(Object qs){
        return join(qs, " ");
    }
Object __act102(Object q, Object r, Object n, Object as, Object bs){
        String body = ""+ q +" "+ r +" "+ n +"("+ join(as) +") {"+ join(bs) +"}";
        return new Object[] {"Method", body };
    }
Object __act108(Object q, Object r, Object n, Object as, Object bs, Object s){
        String body = "def " + s + n + "("+ join(as) +");" + join(bs) + ";end";
        return new Object[] {"Method", body};
    }
Object __act112(Object q, Object t, Object n, Object xs){
        String body = ""+ q +" "+ t +" "+ n +" = "+ join(xs) +";";
        return new Object[] {"Field", body } ;
    }
Object __act116(Object stm, Object xs){
        String body = stm + join(xs) +";";
        return new Object[] {"Import", body };
    }
Object __act120(Object stm, Object xs){
        String body = stm + join(xs) +";";
        return new Object[] {"Package", body };
    }
Object __act125(Object q, Object xs, Object bs){
        String body = ""+ q +" class "+ join(xs) +" {"+ join(bs) +"}";
        return new Object[] {"Class", body } ;
    }
Object __act133(Object p, Object n, Object sn, Object rs){ return new JMetaOptimizer().parse(p, "optimizeGrammar"); }
Object __act135(Object p, Object l){ return new Object[] {"Line", join(p), l}; }
...
Object __act139(){changed = true; return null;}
boolean __pred140(Object r){return hasRule(r);}
 ...
 class JMetaOptimizer extends BaseParser {
  public Object optimizeGrammar() { Object _t=null; int _start=_pos;
    ...
    sn=_t;
    if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
    java.util.ArrayList<Object> as166=new java.util.ArrayList<Object>();
    while (true) { //many
    _t=optimizeRule();
    if (_t==ERROR) break; else as166.add(_t);
    } _t=as166;
    rs=_t;
    if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
    _t=end();
