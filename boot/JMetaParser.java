package jmeta;
// generated by jmeta on Mon Aug 23 16:51:14 PDT 2010
...
public class JMetaParser extends BaseParser {  public static void main(String[] args) {
  ...
  public Object cbraces() { Object _t=null; int _start=_pos;
    ...
    _t=ERROR; do{ //or
      { int _p72=_pos; _t=ERROR; do { //and
        _t=_str("{");
        if (_t==ERROR) break;
        java.util.ArrayList<Object> as70=new java.util.ArrayList<Object>();
        while (true) { //many
        _t=cbraces();
        if (_t==ERROR) break; else as70.add(_t);
        } _t=as70;
        xs=_t;
        if (_t==ERROR) break;
        _t=_str("}");
  ...
  public Object expr4() { Object _t=null; int _start=_pos;
    ...
    { int _p84=_pos; _t=ERROR; do { //and
      java.util.ArrayList<Object> as83=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=expr3();
      if (_t==ERROR) break; else as83.add(_t);
      } _t=as83;
      xs=_t;
      if (_t==ERROR) break;
  ...
  public Object qualifiers() { Object _t=null; int _start=_pos;
    ...
    { int _p116=_pos; _t=ERROR; do { //and
      java.util.ArrayList<Object> as114=new java.util.ArrayList<Object>();
      _t=ERROR; do{ //or
      ...
      if (_t!=ERROR) { as114.add(_t);
        ...
        if (_t==ERROR) break; else as114.add(_t);
        } _t=as114;
      }
      qs=_t;
      if (_t==ERROR) break;
  ...
  public Object classdef() { Object _t=null; int _start=_pos;
    ...
    { int _p144=_pos; _t=ERROR; do { //and
      ...
      _t=_str("{");
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      java.util.ArrayList<Object> as142=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=cbraces();
      if (_t==ERROR) break; else as142.add(_t);
      } _t=as142;
      bs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=_str("}");
  ...
  public Object parser() { Object _t=null; int _start=_pos;
    ...
    { int _p152=_pos; _t=ERROR; do { //and
      ...
      _t=_str("{");
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      java.util.ArrayList<Object> as150=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=ruleMethod();
      if (_t==ERROR) break; else as150.add(_t);
      } _t=as150;
      rs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=ws();
...
Object __act67(Object rs, Object ls, Object xs, Object n, Object s){ return new Object[] {"HLit", "@"+n}; }
Object __act71(Object xs){ return "{"+ join(xs) +"}"; }
Object __act76(Object s, Object xs){ return new Object[] {"Act", join(xs)}; }
Object __act80(Object xs){ return new Object[] {"Pred", join(xs)}; }
boolean __pred102(Object rn, Object n){ return n.equals(rn); }
Object __act115(Object qs){
        return join(qs, " ");
    }
Object __act120(Object q, Object r, Object n, Object as, Object bs){
        String body = ""+ q +" "+ r +" "+ n +"("+ join(as) +") {"+ join(bs) +"}";
        return new Object[] {"Method", body };
    }
Object __act126(Object q, Object r, Object n, Object as, Object bs, Object s){
        String body = "def " + s + n + "("+ join(as) +");" + join(bs) + ";end";
        return new Object[] {"Method", body};
    }
Object __act130(Object q, Object t, Object n, Object xs){
        String body = ""+ q +" "+ t +" "+ n +" = "+ join(xs) +";";
        return new Object[] {"Field", body } ;
    }
Object __act134(Object stm, Object xs){
...
Object __act143(Object q, Object xs, Object bs){
        String decl = " class "+ join(xs);
        String body = join(bs);
        return new Object[] {"Class", q, decl, body } ;
    }
Object __act151(Object p, Object n, Object sn, Object rs){
                   if (Boolean.getBoolean("jmeta.optimize.debug")) {
                     System.out.println("Before:\n" + print_r(p));
                   }
                   return new JMetaOptimizer().parse(p, "optimizeGrammar");
                }
Object __act153(Object p, Object l){ return new Object[] {"Line", join(p), l}; }
 ...
 class JMetaPass extends BaseParser {  public boolean changed =  false;
  ...
  public Object And() { Object _t=null; int _start=_pos;
    ...
    { int _p164=_pos; _t=ERROR; do { //and
      java.util.ArrayList<Object> as163=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=trans();
      if (_t==ERROR) break; else as163.add(_t);
      } _t=as163;
      xs=_t;
      if (_t==ERROR) break;
      _t=concat(new Object[] {"And"},xs);
...
Object __act157(){changed = true; return null;}
boolean __pred158(Object r){return hasRule(r);}
 ...
 class JMetaOptimizer extends BaseParser {
  public Object optimizeGrammar() { Object _t=null; int _start=_pos;
    ...
    { int _p186=_pos; _t=ERROR; do { //and
      ...
      sn=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      java.util.ArrayList<Object> as184=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=optimizeRule();
      if (_t==ERROR) break; else as184.add(_t);
      } _t=as184;
      rs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=end();
...
Object __act185(Object p, Object n, Object sn, Object rs, Object x){ if (Boolean.getBoolean("jmeta.optimize.debug")) {
                         System.out.println("Opt:\n" + print_r(x));
                       }
                       return x;
                     }
Object __act187(Object r){
