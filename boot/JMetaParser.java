package jmeta;
// generated by jmeta on Wed Apr 06 17:38:05 PDT 2011
...
public class JMetaParser extends BaseParser {  public static void main(String[] args) {
  ...
  public Object symbol() { Object _t=null; int _start=_pos;
    ...
    Object s=null; Object c=null;    do {
    { int _p39=_pos; _t=ERROR; do { //and
      ...
      _t=ERROR; do{ //or
        ...
        { int _p38=_pos; _t=ERROR; do { //and
          _t=_str("'");
          if (_t==ERROR) break;
          java.util.ArrayList<Object> as36=new java.util.ArrayList<Object>();
          ...
          if (_t!=ERROR) { as36.add(_t);
            ...
            if (_t==ERROR) break; else as36.add(_t);
            } _t=as36;
          }
          c=_t;
          if (_t==ERROR) break;
  ...
  public Object rewrite_expr() { Object _t=null; int _start=_pos;
    ...
    _t=ERROR; do{ //or
      ...
      { int _p61=_pos; _t=ERROR; do { //and
        ...
        n=_t;
        if (_t==ERROR) break;
        java.util.ArrayList<Object> as60=new java.util.ArrayList<Object>();
        while (true) { //many
        _t=rewrite_expr();
        if (_t==ERROR) break; else as60.add(_t);
        } _t=as60;
        c=_t;
        if (_t==ERROR) break;
        _t=ws();
  ...
  public Object semPred() { Object _t=null; int _start=_pos;
    ...
    { int _p86=_pos; _t=ERROR; do { //and
      _t=_str("?{");
      if (_t==ERROR) break;
      java.util.ArrayList<Object> as84=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=cbraces();
      if (_t==ERROR) break; else as84.add(_t);
      } _t=as84;
      xs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=_str("}");
  ...
  public Object tokens() { Object _t=null; int _start=_pos;
    _t=_retrieve("JMetaParser"+"."+"tokens"); if (_t!=NOT_MEMOIZED) return _t;
    Object a=null; Object b=null;    do {
    { int _p91=_pos; _t=ERROR; do { //and
      ...
      _t=ERROR; do{ //or
        { int _p90=_pos; _t=ERROR; do { //and
          ...
          b=_t;
          if (_t==ERROR) break;
          _t=new Object[] {"TokenRange", a, b};
          if (_t==ERROR) break;
        } while(false); if (_t==ERROR) _pos=_p90; }
        if (_t!=ERROR) break;

        _t=new Object[] {"Token", a};
        if (_t!=ERROR) break;
      } while(false);
      if (_t==ERROR) break;
    } while(false); if (_t==ERROR) _pos=_p91; }
    _t=_memoize("JMetaParser"+"."+"tokens", _start, _t);
    } while (_t==GROW); if (_t==ERROR) ERROR.last="tokens"; return _t;
  }
  ...
  public Object rule() { Object _t=null; int _start=_pos;
    ...
    _t=ERROR; do{ //or
      { int _p111=_pos; _t=ERROR; do { //and
        ...
        x=_t;
        if (_t==ERROR) break;
        java.util.ArrayList<Object> as110=new java.util.ArrayList<Object>();
        while (true) { //many
        ...
        if (_t==ERROR) break; else as110.add(_t);
        } _t=as110;
        xs=_t;
        if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
        _t=ws();
        ...
        _t=_str(";");
        if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
        _t=new Object[] {"MemoRule", n, concat(new Object[] {"Or", x},xs)};
        if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      ...
      { int _p116=_pos; _t=ERROR; do { //and
        ...
        x=_t;
        if (_t==ERROR) break;
        java.util.ArrayList<Object> as115=new java.util.ArrayList<Object>();
        while (true) { //many
        ...
        if (_t==ERROR) break; else as115.add(_t);
        } _t=as115;
        xs=_t;
        if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
        _t=ws();
  ...
  public Object rulePart() { Object _t=null; int _start=_pos;
    ...
    { int _p120=_pos; _t=ERROR; do { //and
      ...
      n=_t;
      if (_t==ERROR) break;
      if (!__pred117(rn,n)) _t=ERROR;
      if (_t==ERROR) break;
      _t=ERROR; do{ //or
        { int _p119=_pos; _t=ERROR; do { //and
          { int _p118=_pos; _t=ERROR; do { //and
            _t=ws();
            if (_t==ERROR) break;
            _push("scope"); _t=k();
            if (_t==ERROR) break;
            ...
            _t=_str(")");
            if (_t==ERROR) break;
          } while(false); if (_t==ERROR) _pos=_p118; }
          s=_t;
          if (_t==ERROR) break;
          _t=ruleStuff();
          c=_t;
  ...
  public Object method() { Object _t=null; int _start=_pos;
    ...
    _t=ERROR; do{ //or
      ...
      { int _p142=_pos; _t=ERROR; do { //and
        ...
        _t=_str("{");
        if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
        java.util.ArrayList<Object> as140=new java.util.ArrayList<Object>();
        while (true) { //many
        _t=cbraces();
        if (_t==ERROR) break; else as140.add(_t);
        } _t=as140;
        bs=_t;
        if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
        _t=_str("}");
        if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
        _t=__act141(q,r,n,as,bs,s);
        if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
  ...
  public Object field() { Object _t=null; int _start=_pos;
    ...
    { int _p146=_pos; _t=ERROR; do { //and
      ...
      _t=_str("=");
      if (_t==ERROR) break;
      java.util.ArrayList<Object> as144=new java.util.ArrayList<Object>();
      while (true) { //many
      ...
      if (_t==ERROR) break; else as144.add(_t);
      } _t=as144;
      xs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=_str(";");
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=__act145(q,t,n,xs);
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
  ...
  public Object jpackage() { Object _t=null; int _start=_pos;
    ...
    { int _p154=_pos; _t=ERROR; do { //and
      ...
      stm=_t;
      if (_t==ERROR) break;
      java.util.ArrayList<Object> as152=new java.util.ArrayList<Object>();
      while (true) { //many
      ...
      if (_t==ERROR) break; else as152.add(_t);
      } _t=as152;
      xs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=_str(";");
  ...
  public Object classdef() { Object _t=null; int _start=_pos;
    ...
    { int _p159=_pos; _t=ERROR; do { //and
      ...
      _t=_str("{");
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      java.util.ArrayList<Object> as157=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=cbraces();
      if (_t==ERROR) break; else as157.add(_t);
      } _t=as157;
      bs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=_str("}");
  ...
  public Object parser() { Object _t=null; int _start=_pos;
    ...
    { int _p167=_pos; _t=ERROR; do { //and
      _t=ws();
      if (_t==ERROR) break;
      _t=ERROR; do{ //or
        _push("public"); _t=k();
      ...
      p=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=__act166(p,n,sn,rs);
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
    } while(false); if (_t==ERROR) _pos=_p167; }
  ...
  public Object file() { Object _t=null; int _start=_pos;
    ...
    { int _p171=_pos; _t=ERROR; do { //and
      java.util.ArrayList<Object> as170=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=line();
      if (_t==ERROR) break; else as170.add(_t);
      } _t=as170;
      ls=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=ws();
...
Object __act37(Object s, Object c){return join(c);}
Object __act48(Object x){return ((String)x)+".";}
Object __act51(Object x, Object t, Object n){return join(t) + n;}
Object __act55(Object x){return "("+join(x)+")";}
Object __act57(Object n, Object p){ return new Object[] {"HLit", ((String)n)+p}; }
Object __act72(Object rs, Object ls, Object xs, Object n, Object s){ return new Object[] {"HLit", "@"+n}; }
Object __act76(Object xs){ return "{"+ join(xs) +"}"; }
Object __act81(Object s, Object xs){ return new Object[] {"Act", join(xs)}; }
Object __act85(Object xs){ return new Object[] {"Pred", join(xs)}; }
boolean __pred117(Object rn, Object n){ return n.equals(rn); }
Object __act130(Object qs){
        return join(qs, " ");
    }
Object __act135(Object q, Object r, Object n, Object as, Object bs){
        String body = ""+ q +" "+ r +" "+ n +"("+ join(as) +") {"+ join(bs) +"}";
        return new Object[] {"Method", body };
    }
Object __act141(Object q, Object r, Object n, Object as, Object bs, Object s){
        return new Object[] {"Method", (String)s + n, join(as), join(bs)};
    }
Object __act145(Object q, Object t, Object n, Object xs){
        String body = ""+ q +" "+ t +" "+ n +" = "+ join(xs) +";";
        return new Object[] {"Field", body } ;
    }
Object __act149(Object stm, Object xs){
        String body = stm + join(xs) +";";
        return new Object[] {"Import", body };
    }
Object __act153(Object stm, Object xs){
        String body = stm + join(xs) +";";
        return new Object[] {"Package", body };
    }
Object __act158(Object q, Object xs, Object bs){
        String decl = " class "+ join(xs);
        String body = join(bs);
        return new Object[] {"Class", q, decl, body } ;
    }
Object __act166(Object p, Object n, Object sn, Object rs){
                   if (Boolean.getBoolean("jmeta.optimize.debug")) {
                     System.out.println("Before:\n" + print_r(p));
                   }
                   return new JMetaOptimizer().parse(p, "optimizeGrammar");
                }
Object __act168(Object p, Object l){ return new Object[] {"Line", join(p), l}; }
 ...
 class JMetaPass extends BaseParser {  public boolean changed =  false;
  ...
  public Object And() { Object _t=null; int _start=_pos;
    ...
    { int _p179=_pos; _t=ERROR; do { //and
      java.util.ArrayList<Object> as178=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=trans();
      if (_t==ERROR) break; else as178.add(_t);
      } _t=as178;
      xs=_t;
      if (_t==ERROR) break;
      _t=concat(new Object[] {"And"},xs);
  ...
  public Object SynPred() { Object _t=null; int _start=_pos;
    ...
    { int _p188=_pos; _t=ERROR; do { //and
      java.util.ArrayList<Object> as187=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=trans();
      if (_t==ERROR) break; else as187.add(_t);
      } _t=as187;
      xs=_t;
      if (_t==ERROR) break;
  ...
  public Object start() { Object _t=null; int _start=_pos;
    ...
    _t=ERROR; do{ //or
      ...
      { int _p190=_pos; _t=ERROR; do { //and
        _t=_any();
        r=_t;
        if (_t==ERROR) break;
        _t=end();
        ...
        _t=r;
        if (_t==ERROR) break;
      } while(false); if (_t==ERROR) _pos=_p190; }
      if (_t!=ERROR) break;

      { int _p192=_pos; _t=ERROR; do { //and
        java.util.ArrayList<Object> as191=new java.util.ArrayList<Object>();
        while (true) { //many
        _t=_any();
        if (_t==ERROR) break; else as191.add(_t);
        } _t=as191;
        r=_t;
        if (_t==ERROR) break;
        _t=end();
...
Object __act172(){changed = true; return null;}
boolean __pred173(Object r){return hasRule(r);}
 ...
 class JMetaAndOrOpt extends JMetaPass {
  public Object And() { Object _t=null; int _start=_pos;
    ...
    _t=ERROR; do{ //or
      { int _p193=_pos; _t=ERROR; do { //and
        _t=trans();
        x=_t;
        if (_t==ERROR) break;
        _t=end();
        ...
        _t=x;
        if (_t==ERROR) break;
      } while(false); if (_t==ERROR) _pos=_p193; }
      if (_t!=ERROR) break;
  ...
  public Object Or() { Object _t=null; int _start=_pos;
    ...
    Object x=null; Object xs=null;    do {
    _t=ERROR; do{ //or
      { int _p195=_pos; _t=ERROR; do { //and
        _t=trans();
        x=_t;
        if (_t==ERROR) break;
        _t=end();
        ...
        _t=x;
        if (_t==ERROR) break;
      } while(false); if (_t==ERROR) _pos=_p195; }
      if (_t!=ERROR) break;

      { int _p196=_pos; _t=ERROR; do { //and
        _push("Or"); _t=transInside();
        xs=_t;
        if (_t==ERROR) break;
        _t=concat(new Object[] {"Or"},xs);
        if (_t==ERROR) break;
      } while(false); if (_t==ERROR) _pos=_p196; }
      if (_t!=ERROR) break;
    } while(false);
  ...
  public Object transInside() { Object _t=null; int _start=_pos;
    ...
    { int _p200=_pos; _t=ERROR; do { //and
      _t=_any();
      s=_t;
      if (_t==ERROR) break;
      _t=ERROR; do{ //or
        { int _p198=_pos; _t=ERROR; do { //and
          _t=_listBegin(); if (_t!=ERROR) {
            { int _p197=_pos; _t=ERROR; do { //and
              _push(s); _t=sym();
              if (_t==ERROR) break;
              _push(s); _t=transInside();
              xs=_t;
              if (_t==ERROR) break;
            } while(false); if (_t==ERROR) _pos=_p197; }
          _listEnd(); }
          if (_t==ERROR) break;
          _push(s); _t=transInside();
          ys=_t;
          ...
          _t=concat(xs,ys);
          if (_t==ERROR) break;
        } while(false); if (_t==ERROR) _pos=_p198; }
        if (_t!=ERROR) break;

        { int _p199=_pos; _t=ERROR; do { //and
          _t=trans();
          x=_t;
          if (_t==ERROR) break;
          _push(s); _t=transInside();
          ...
          if (_t==ERROR) break;
        } while(false); if (_t==ERROR) _pos=_p199; }
        if (_t!=ERROR) break;
      ...
      if (_t==ERROR) break;
    } while(false); if (_t==ERROR) _pos=_p200; }
 ...
 class JMetaOptimizer extends BaseParser {
  public Object optimizeGrammar() { Object _t=null; int _start=_pos;
    ...
    { int _p203=_pos; _t=ERROR; do { //and
      _t=_sym("Parser");
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=_any();
      p=_t;
      ...
      sn=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      java.util.ArrayList<Object> as201=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=optimizeRule();
      if (_t==ERROR) break; else as201.add(_t);
      } _t=as201;
      rs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=end();
      ...
      x=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=__act202(p,n,sn,rs,x);
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
    } while(false); if (_t==ERROR) _pos=_p203; }
  ...
  public Object optimizeRule() { Object _t=null; int _start=_pos;
    ...
    Object r=null;    do {
    { int _p205=_pos; _t=ERROR; do { //and
      _t=_any();
      r=_t;
      if (_t==ERROR) break;
      _t=__act204(r);
      if (_t==ERROR) break;
    } while(false); if (_t==ERROR) _pos=_p205; }
    _t=_memoize("JMetaOptimizer"+"."+"optimizeRule", _start, _t);
    } while (_t==GROW); if (_t==ERROR) ERROR.last="optimizeRule"; return _t;
  }
Object __act202(Object p, Object n, Object sn, Object rs, Object x){ if (Boolean.getBoolean("jmeta.optimize.debug")) {
                         System.out.println("Opt:\n" + print_r(x));
                       }
                       return x;
                     }
Object __act204(Object r){
