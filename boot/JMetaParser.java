package jmeta;
// generated by jmeta on Mon Aug 09 10:09:49 PDT 2010
...
public class JMetaParser extends BaseParser {  public static void main(String[] args) {
  ...
  public Object cbraces() { Object _t=null; int _start=_pos;
    ...
    _t=ERROR; do{ //or
      { int _p71=_pos; _t=ERROR; do { //and
        _t=_str("{");
        if (_t==ERROR) break;
        java.util.ArrayList<Object> as69=new java.util.ArrayList<Object>();
        while (true) { //many
        _t=cbraces();
        if (_t==ERROR) break; else as69.add(_t);
        } _t=as69;
        xs=_t;
        if (_t==ERROR) break;
        _t=_str("}");
  ...
  public Object semAction() { Object _t=null; int _start=_pos;
    ...
    _t=ERROR; do{ //or
      ...
      { int _p76=_pos; _t=ERROR; do { //and
        _t=_str("{");
        if (_t==ERROR) break;
        java.util.ArrayList<Object> as74=new java.util.ArrayList<Object>();
        while (true) { //many
        _t=cbraces();
        if (_t==ERROR) break; else as74.add(_t);
        } _t=as74;
        xs=_t;
        if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
        _t=_str("}");
  ...
  public Object expr4() { Object _t=null; int _start=_pos;
    ...
    { int _p83=_pos; _t=ERROR; do { //and
      java.util.ArrayList<Object> as82=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=expr3();
      if (_t==ERROR) break; else as82.add(_t);
      } _t=as82;
      xs=_t;
      if (_t==ERROR) break;
  ...
  public Object rule() { Object _t=null; int _start=_pos;
    ...
    { int _p100=_pos; _t=ERROR; do { //and
      ...
      x=_t;
      if (_t==ERROR) break;
      java.util.ArrayList<Object> as99=new java.util.ArrayList<Object>();
      while (true) { //many
      ...
      if (_t==ERROR) break; else as99.add(_t);
      } _t=as99;
      xs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=ws();
...
Object __act66(Object rs, Object ls, Object xs, Object n, Object s){ return new Object[] {"HLit", "@"+n}; }
Object __act70(Object xs){ return "{"+ join(xs) +"}"; }
Object __act75(Object s, Object xs){ return new Object[] {"Act", join(xs)}; }
Object __act79(Object xs){ return new Object[] {"Pred", join(xs)}; }
boolean __pred101(Object rn, Object n){ return n.equals(rn); }
Object __act114(Object qs){
        return join(qs, " ");
    }
Object __act119(Object q, Object r, Object n, Object as, Object bs){
        String body = ""+ q +" "+ r +" "+ n +"("+ join(as) +") {"+ join(bs) +"}";
        return new Object[] {"Method", body };
    }
Object __act125(Object q, Object r, Object n, Object as, Object bs, Object s){
        String body = "def " + s + n + "("+ join(as) +");" + join(bs) + ";end";
        return new Object[] {"Method", body};
    }
Object __act129(Object q, Object t, Object n, Object xs){
        String body = ""+ q +" "+ t +" "+ n +" = "+ join(xs) +";";
        return new Object[] {"Field", body } ;
    }
Object __act133(Object stm, Object xs){
        String body = stm + join(xs) +";";
        return new Object[] {"Import", body };
    }
Object __act137(Object stm, Object xs){
        String body = stm + join(xs) +";";
        return new Object[] {"Package", body };
    }
Object __act142(Object q, Object xs, Object bs){
        String decl = " class "+ join(xs);
        String body = join(bs);
        return new Object[] {"Class", q, decl, body } ;
    }
Object __act150(Object p, Object n, Object sn, Object rs){ return new JMetaOptimizer().parse(p, "optimizeGrammar"); }
Object __act152(Object p, Object l){ return new Object[] {"Line", join(p), l}; }
 ...
 class JMetaPass extends BaseParser {  public boolean changed =  false;
  ...
  public Object Or() { Object _t=null; int _start=_pos;
    ...
    { int _p161=_pos; _t=ERROR; do { //and
      java.util.ArrayList<Object> as160=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=trans();
      if (_t==ERROR) break; else as160.add(_t);
      } _t=as160;
      xs=_t;
      if (_t==ERROR) break;
      _t=concat(new Object[] {"Or"},xs);
  ...
  public Object start() { Object _t=null; int _start=_pos;
    ...
    _t=ERROR; do{ //or
      ...
      { int _p174=_pos; _t=ERROR; do { //and
        java.util.ArrayList<Object> as173=new java.util.ArrayList<Object>();
        while (true) { //many
        _t=_any();
        if (_t==ERROR) break; else as173.add(_t);
        } _t=as173;
        r=_t;
        if (_t==ERROR) break;
        _t=end();
...
Object __act156(){changed = true; return null;}
boolean __pred157(Object r){return hasRule(r);}
