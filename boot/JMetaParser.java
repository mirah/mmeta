package jmeta;
// generated by jmeta on Thu Aug 26 23:22:28 PDT 2010
...
public class JMetaParser extends BaseParser {  public static void main(String[] args) {
  ...
  public Object rule() { Object _t=null; int _start=_pos;
    ...
    _t=ERROR; do{ //or
      { int _p107=_pos; _t=ERROR; do { //and
        ...
        x=_t;
        if (_t==ERROR) break;
        java.util.ArrayList<Object> as106=new java.util.ArrayList<Object>();
        while (true) { //many
        ...
        if (_t==ERROR) break; else as106.add(_t);
        } _t=as106;
        xs=_t;
        if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
        _t=ws();
  ...
  public Object classdef() { Object _t=null; int _start=_pos;
    ...
    { int _p155=_pos; _t=ERROR; do { //and
      ...
      _t=_str("{");
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      java.util.ArrayList<Object> as153=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=cbraces();
      if (_t==ERROR) break; else as153.add(_t);
      } _t=as153;
      bs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=_str("}");
  ...
  public Object parser() { Object _t=null; int _start=_pos;
    ...
    { int _p163=_pos; _t=ERROR; do { //and
      ...
      _t=_str("{");
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      java.util.ArrayList<Object> as161=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=ruleMethod();
      if (_t==ERROR) break; else as161.add(_t);
      } _t=as161;
      rs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=ws();
...
boolean __pred113(Object rn, Object n){ return n.equals(rn); }
Object __act126(Object qs){
        return join(qs, " ");
    }
Object __act131(Object q, Object r, Object n, Object as, Object bs){
        String body = ""+ q +" "+ r +" "+ n +"("+ join(as) +") {"+ join(bs) +"}";
        return new Object[] {"Method", body };
    }
Object __act137(Object q, Object r, Object n, Object as, Object bs, Object s){
        String body = "def " + s + n + "("+ join(as) +");" + join(bs) + ";end";
        return new Object[] {"Method", body};
    }
Object __act141(Object q, Object t, Object n, Object xs){
        String body = ""+ q +" "+ t +" "+ n +" = "+ join(xs) +";";
        return new Object[] {"Field", body } ;
    }
Object __act145(Object stm, Object xs){
...
Object __act154(Object q, Object xs, Object bs){
        String decl = " class "+ join(xs);
        String body = join(bs);
        return new Object[] {"Class", q, decl, body } ;
    }
Object __act162(Object p, Object n, Object sn, Object rs){
                   if (Boolean.getBoolean("jmeta.optimize.debug")) {
                     System.out.println("Before:\n" + print_r(p));
                   }
                   return new JMetaOptimizer().parse(p, "optimizeGrammar");
                }
Object __act164(Object p, Object l){ return new Object[] {"Line", join(p), l}; }
 ...
 class JMetaPass extends BaseParser {  public boolean changed =  false;
  ...
  public Object Or() { Object _t=null; int _start=_pos;
    ...
    { int _p173=_pos; _t=ERROR; do { //and
      java.util.ArrayList<Object> as172=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=trans();
      if (_t==ERROR) break; else as172.add(_t);
      } _t=as172;
      xs=_t;
      if (_t==ERROR) break;
      _t=concat(new Object[] {"Or"},xs);
  ...
  public Object And() { Object _t=null; int _start=_pos;
    ...
    { int _p175=_pos; _t=ERROR; do { //and
      java.util.ArrayList<Object> as174=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=trans();
      if (_t==ERROR) break; else as174.add(_t);
      } _t=as174;
      xs=_t;
      if (_t==ERROR) break;
      _t=concat(new Object[] {"And"},xs);
  ...
  public Object SynPred() { Object _t=null; int _start=_pos;
    ...
    { int _p184=_pos; _t=ERROR; do { //and
      java.util.ArrayList<Object> as183=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=trans();
      if (_t==ERROR) break; else as183.add(_t);
      } _t=as183;
      xs=_t;
      if (_t==ERROR) break;
...
Object __act168(){changed = true; return null;}
boolean __pred169(Object r){return hasRule(r);}
 ...
 class JMetaAndOrOpt extends JMetaPass {
  ...
  public Object Or() { Object _t=null; int _start=_pos;
    ...
    Object x=null; Object xs=null;    do {
    _t=ERROR; do{ //or
      { int _p191=_pos; _t=ERROR; do { //and
        _t=trans();
        x=_t;
        if (_t==ERROR) break;
        _t=end();
        ...
        _t=x;
        if (_t==ERROR) break;
      } while(false); if (_t==ERROR) _pos=_p191; }
      if (_t!=ERROR) break;
 ...
 class JMetaOptimizer extends BaseParser {
  public Object optimizeGrammar() { Object _t=null; int _start=_pos;
    ...
    { int _p199=_pos; _t=ERROR; do { //and
      ...
      sn=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      java.util.ArrayList<Object> as197=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=optimizeRule();
      if (_t==ERROR) break; else as197.add(_t);
      } _t=as197;
      rs=_t;
      if (_t==ERROR) throw new SyntaxError("", _pos, _string, _list);
      _t=end();
  ...
  public Object optimizeRule() { Object _t=null; int _start=_pos;
    ...
    Object r=null;    do {
    { int _p201=_pos; _t=ERROR; do { //and
      _t=_any();
      r=_t;
      if (_t==ERROR) break;
      _t=__act200(r);
      if (_t==ERROR) break;
    } while(false); if (_t==ERROR) _pos=_p201; }
    _t=_memoize("JMetaOptimizer"+"."+"optimizeRule", _start, _t);
    } while (_t==GROW); if (_t==ERROR) ERROR.last="optimizeRule"; return _t;
  }
Object __act198(Object p, Object n, Object sn, Object rs, Object x){ if (Boolean.getBoolean("jmeta.optimize.debug")) {
                         System.out.println("Opt:\n" + print_r(x));
                       }
                       return x;
                     }
Object __act200(Object r){
