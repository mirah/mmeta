package jmeta;
// generated by jmeta on Tue Aug 03 21:25:26 PDT 2010
...
public class JMetaParser extends BaseParser {  public static void main(String[] args) {
  ...
  public Object tsString() { Object _t=null; int _start=_pos;
    ...
    { int _p18=_pos; _t=ERROR; do { //and
      _t=_str("\"");
      if (_t==ERROR) break;
      java.util.ArrayList<Object> as16=new java.util.ArrayList<Object>();
      while (true) { //many
      ...
      if (_t==ERROR) break; else as16.add(_t);
      } _t=as16;
      xs=_t;
      if (_t==ERROR) break;
      _t=_str("\"");
  ...
  public Object dollar() { Object _t=null; int _start=_pos;
    ...
    _t=ERROR; do{ //or
      { int _p21=_pos; _t=ERROR; do { //and
        _t=_str("${");
        if (_t==ERROR) break;
        java.util.ArrayList<Object> as19=new java.util.ArrayList<Object>();
        while (true) { //many
        _t=cbraces();
        if (_t==ERROR) break; else as19.add(_t);
        } _t=as19;
        xs=_t;
        if (_t==ERROR) break;
        _t=_str("}");
        ...
        _t=__act20(xs);
        if (_t==ERROR) break;
      } while(false); if (_t==ERROR) _pos=_p21; }
      if (_t!=ERROR) break;
  ...
  public Object dollarstring() { Object _t=null; int _start=_pos;
    ...
    { int _p27=_pos; _t=ERROR; do { //and
      _t=_str("\"");
      if (_t==ERROR) break;
      java.util.ArrayList<Object> as25=new java.util.ArrayList<Object>();
      while (true) { //many
      ...
      if (_t==ERROR) break; else as25.add(_t);
      } _t=as25;
      xs=_t;
      if (_t==ERROR) break;
      _t=_str("\"");
  ...
  public Object number() { Object _t=null; int _start=_pos;
    ...
    { int _p31=_pos; _t=ERROR; do { //and
      ...
      sign=_t;
      if (_t==ERROR) break;
      java.util.ArrayList<Object> as29=new java.util.ArrayList<Object>();
      _t=digit();
      if (_t!=ERROR) { as29.add(_t);
        while (true) { //many
        _t=digit();
        if (_t==ERROR) break; else as29.add(_t);
        } _t=as29;
      }
      ds=_t;
      if (_t==ERROR) break;
  ...
  public Object parens() { Object _t=null; int _start=_pos;
    ...
    { int _p50=_pos; _t=ERROR; do { //and
      _t=_str("(");
      if (_t==ERROR) break;
      java.util.ArrayList<Object> as48=new java.util.ArrayList<Object>();
      while (true) { //many
      _t=ERROR; do{ //or
          _t=parens();
          if (_t!=ERROR) break;
      ...
      if (_t==ERROR) break; else as48.add(_t);
      } _t=as48;
      x=_t;
      if (_t==ERROR) break;
      _t=_str(")");
...
Object __act13(Object c){ return "\\" + c; }
Object __act17(Object xs){ return join(xs); }
Object __act20(Object xs){ return "\"+"+ join(xs)+ "+\""; }
Object __act22(Object xs, Object n){ return "\"+"+ n +"+\"";        }
Object __act26(Object xs){ return join(xs); }
Object __act30(Object sign, Object ds){ return new Object[] {"HLit", ""+ sign + join(ds)}; }
Object __act42(Object x){return ((String)x)+".";}
Object __act45(Object x, Object t, Object n){return join(t) + n;}
Object __act49(Object x){return "("+join(x)+")";}
Object __act51(Object n, Object p){ return new Object[] {"HLit", ((String)n)+p}; }
