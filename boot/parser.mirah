# generated by mmeta on Mon May 02 13:20:10 PDT 2011
                ...
                begin
                  begin
                    ...
                    begin
                                ...
                                begin
                                  ...
                                  begin
                                    ...
                                    begin  # ';'
                                      ...
                                      raise @error unless @chars[_p174] == 59
                                      _p174 += 1
                                      self._pos = _p174
                                      ";"
                                    end
                      ...
                      begin  # ';'
                        _p177 = _pos
                        raise @error if _p177 + 1 > @chars.length
                        raise @error unless @chars[_p177] == 59
                        _p177 += 1
                        self._pos = _p177
                        ";"
                      end
                      ["MemoRule", t, n, concat(["Or", x], xs)]
                    rescue RuleFailure => ex
                      self._pos = _p178
                      raise ex
                    end
                              ...
                              _li = Object(
                                begin
                                  ...
                                  begin
                                    ...
                                    begin  # ';'
                                      _p182 = _pos
                                      raise @error if _p182 + 1 > @chars.length
                                      raise @error unless @chars[_p182] == 59
                                      _p182 += 1
                                      self._pos = _p182
                                      ";"
                                    end
  ...
  def rulePart
    ...
    begin
      ...
      begin
        _t2 = (
          begin
            ...
            begin
              ...
              raise @error unless ( n.equals(rn) )
              begin
                begin
                  begin
                    _p191 = _pos
                        ...
                        begin
                          ...
                          begin
                            ...
                            begin  # '('
                              ...
                              raise @error unless @chars[_p188] == 40
                              _p188 += 1
                              self._pos = _p188
                              "("
                            end
                            ...
                            begin  # ')'
                              _p189 = _pos
                              raise @error if _p189 + 1 > @chars.length
                              raise @error unless @chars[_p189] == 41
                              _p189 += 1
                              self._pos = _p189
                              ")"
                            end
        ...
        _t = _memoize("MMetaParser.rulePart", _start, ex)
      else
        _t = _memoize("MMetaParser.rulePart", _start, _t)
      end
    rescue RuleFailure => ex
      ex.last = 'rulePart'
      raise ex
              ...
              begin
                begin
                  ...
                  begin
                    ...
                    begin  # ':'
                      _p193 = _pos
                      raise @error if _p193 + 1 > @chars.length
                      raise @error unless @chars[_p193] == 58
                      _p193 += 1
                      self._pos = _p193
                      ":"
                    end
        ...
        _t2 = (
          begin
            ...
            begin
              begin  # 'def'
                _p205 = _pos
                raise @error if _p205 + 3 > @chars.length
                raise @error unless @chars[_p205] == 100
                _p205 += 1
                raise @error unless @chars[_p205] == 101
                _p205 += 1
                raise @error unless @chars[_p205] == 102
                _p205 += 1
                self._pos = _p205
                "def"
              end
              ...
              s = (
                begin
                  begin  # 'self.'
                    _p206 = _pos
                    raise @error if _p206 + 5 > @chars.length
                    raise @error unless @chars[_p206] == 115
                    _p206 += 1
                    raise @error unless @chars[_p206] == 101
                    _p206 += 1
                    raise @error unless @chars[_p206] == 108
                    _p206 += 1
                    raise @error unless @chars[_p206] == 102
                    _p206 += 1
                    raise @error unless @chars[_p206] == 46
                    _p206 += 1
                    self._pos = _p206
                    "self."
                  end
                          ...
                          begin
                            begin
                              ...
                              begin
                                ...
                                begin  # '('
                                  _p207 = _pos
                                  raise @error if _p207 + 1 > @chars.length
                                  raise @error unless @chars[_p207] == 40
                                  _p207 += 1
                                  self._pos = _p207
                                  "("
                                end
                                            ...
                                            begin
                                              begin  # not
                                                begin  # ')'
                                                  ...
                                                  raise @error unless @chars[_p208] == 41
                                                  _p208 += 1
                                                  self._pos = _p208
                                                  ")"
                                                end
                                ...
                                begin  # ')'
                                  _p211 = _pos
                                  raise @error if _p211 + 1 > @chars.length
                                  raise @error unless @chars[_p211] == 41
                                  _p211 += 1
                                  self._pos = _p211
                                  ")"
                                end
                          ...
                          begin
                            begin
                              ...
                              begin
                                ...
                                begin  # '{'
                                  _p213 = _pos
                                  raise @error if _p213 + 1 > @chars.length
                                  raise @error unless @chars[_p213] == 123
                                  _p213 += 1
                                  self._pos = _p213
                                  "{"
                                end
                                ...
                                begin  # '}'
                                  _p215 = _pos
                                  raise @error if _p215 + 1 > @chars.length
                                  raise @error unless @chars[_p215] == 125
                                  _p215 += 1
                                  self._pos = _p215
                                  "}"
                                end
                ...
                begin
                  ...
                  begin
                    ...
                    begin  # optional
                      begin  # ';'
                        _p227 = _pos
                        raise @error if _p227 + 1 > @chars.length
                        raise @error unless @chars[_p227] == 59
                        _p227 += 1
                        self._pos = _p227
                        ";"
                      end
              ...
              begin
                begin
                  ...
                  begin
                                ...
                                begin
                                  begin  # not
                                    begin  # '{'
                                      ...
                                      raise @error unless @chars[_p230] == 123
                                      _p230 += 1
                                      self._pos = _p230
                                      "{"
                                    end
                    ...
                    begin  # '{'
                      _p233 = _pos
                      raise @error if _p233 + 1 > @chars.length
                      raise @error unless @chars[_p233] == 123
                      _p233 += 1
                      self._pos = _p233
                      "{"
                    end
                    ...
                    begin  # '}'
                      ...
                      raise @error unless @chars[_p235] == 125
                      _p235 += 1
                      self._pos = _p235
                      "}"
                    end
              ...
              begin
                begin
                  ...
                  begin
                            ...
                            begin
                              ...
                              begin
                                ...
                                begin
                                  ...
                                  begin  # '<'
                                    _p240 = _pos
                                    raise @error if _p240 + 1 > @chars.length
                                    raise @error unless @chars[_p240] == 60
                                    _p240 += 1
                                    self._pos = _p240
                                    "<"
                                  end
                    ...
                    begin  # '{'
                      _p244 = _pos
                      raise @error if _p244 + 1 > @chars.length
                      raise @error unless @chars[_p244] == 123
                      _p244 += 1
                      self._pos = _p244
                      "{"
                    end
                    ...
                    begin  # '}'
                      _p246 = _pos
                      raise @error if _p246 + 1 > @chars.length
                      raise @error unless @chars[_p246] == 125
                      _p246 += 1
                      self._pos = _p246
                      "}"
                    end
...
class MMetaPass < BaseParser
  ...
  def MemoRule
    ...
    begin
      ...
      n = nil
      x = nil
      _t = _sretrieve("MMetaPass.MemoRule")
      return _t unless _t == BaseParser.NOT_MEMOIZED
      begin
        _t2 = (
          begin
        ...
        _t = _memoize("MMetaPass.MemoRule", _start, ex)
      else
        _t = _memoize("MMetaPass.MemoRule", _start, _t)
      end
    rescue RuleFailure => ex
      ex.last = 'MemoRule'
      raise ex
