package jmeta;
// generated by jmeta on Fri Jul 16 07:50:07 PDT 2010
...
public class JMetaCompiler extends BaseParser {  public Object jpackage =  null;
  ...
  public Object And() { Object _t=null; int _start=_pos;
    ...
    { int _p41=_pos; _t=ERROR; do { //and
      _t=indent();
      if (_t==ERROR) break;
      java.util.ArrayList<Object> as39=new java.util.ArrayList<Object>();
      _t=trans();
      if (_t!=ERROR) { as39.add(_t);
        while (true) { //many
        _t=trans();
        if (_t==ERROR) break; else as39.add(_t);
        } _t=as39;
      }
      ts=_t;
      if (_t==ERROR) break;
  ...
  public Object Parser() { Object _t=null; int _start=_pos;
    ...
    _t=__act57(p,n,s);
    if (_t==ERROR) break;
    java.util.ArrayList<Object> as58=new java.util.ArrayList<Object>();
    while (true) { //many
    _t=trans();
    if (_t==ERROR) break; else as58.add(_t);
    } _t=as58;
    xs=_t;
    if (_t==ERROR) break;
    _t=__act59(p,n,s,xs);
...
Object __act28(Object expr){ return w(
        "_t=", expr, ";"
    ); }
Object __act30(Object expr){
        String var = genvar();
        methods.add(w(
...
Object __act34(Object x){ return w(
        _, x, "\n",
        _, "if (_t!=ERROR) break;\n"
    ); }
Object __act37(Object x, Object xs){ return w(
        "_t=ERROR; do{ //or\n",
        join(xs, "\n"),
        _, "} while(false);"
    ); }
Object __act40(Object ts){
        String var = genvar();
        String err = null;
...
Object __act42(Object ts){ return w(
        ""
    );}
Object __act43(Object x){ return makeMany(x, false); }
Object __act45(Object x){ return makeMany(x, true);  }
Object __act47(Object x){ return w(
        _, x, "\n",
        _, "if (_t==ERROR) if (_string != null) { _t=\"\"; } else { _t=null; }"
    ); }
Object __act49(Object x){ return w(
        _, x, "\n",
        _, "if (_t==ERROR) { _t=true; } else { _t=ERROR; }"
    );}
Object __act51(Object x){ String var = genvar(); return w(
        "{ int _l", var, "=_pos;\n",
        _, x, "\n",
        _, "if (_t!=ERROR) { _pos=_l", var, "; }}"
    );}
Object __act53(Object x){ return w(
        "_t=_listBegin(); if (_t!=ERROR) {\n",
        _, "  ", x, "\n",
        _, "_listEnd(); }"
    );}
Object __act55(Object n, Object b){ rules.add(n); return w(
        "\n",
...
Object __act57(Object p, Object n, Object s){ name = (String)n; sname = (String)s; return null; }
Object __act59(Object p, Object n, Object s, Object xs){
        String b = "\n";
        b = w(b,
...
Object __act61(Object c){ return w("  ", c, "\n"); }
Object __act63(Object c){ return w("  ", c, "\n"); }
Object __act65(Object c){ jpackage = c; return ""; }
Object __act69(Object ws, Object x){ return w(ws, x); }
Object __act72(Object xs){ return w(
